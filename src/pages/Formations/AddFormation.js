...
function AddFormation() {
  ...
  const [durMensIsValid, setDurMensIsValid] = useState(
  ...
  const handleSubmit = async (formation) => {
    ...
    if (
      ...
      mtAnnIsValid === "form-control is-invalid" ||
      durAnnIsValid === "form-control is-invalid" ||
      durMens === "form-control is-invalid" ||
      ...
      const response = await fetch(
        process.env.REACT_APP_API_URL + "/createFormation",
        {
          method: "POST",
          body: JSON.stringify({
            nom: name,
                ...
                <Row>
                  ...
                  <Col xs={12} sm={6}>
                    <Form.Group>
                      ...
                      <Form.Control
                        className={mtAnnIsValid}
                        type="number"
                        min={0}
                        onChange={handleMtAnnuelle}
                      />
                    </Form.Group>
                  </Col>
                  <Col xs={12} sm={6}>
                    <Form.Group>
                      ...
                      <Form.Control
                        className={durAnnIsValid}
                        type="number"
                        min="0"
                        onChange={handleDurAnn}
                      />
                    </Form.Group>
                  </Col>
                  ...
                  <Col xs={12} sm={6}>
                    <Form.Group>
                      ...
                      <Form.Control
                        className={durMensIsValid}
                        type="number"
                        min="0"
                        onChange={handleDurMens}
                      />
                    </Form.Group>
                  </Col>
                  ...
                  <Col xs={12} sm={12}>
                    <Form.Group>
                      ...
                      <Form.Control
                        className={dtEchIsValid}
                        type="date"
                        onChange={handleDtEch}
                      />
                    </Form.Group>
                  </Col>
