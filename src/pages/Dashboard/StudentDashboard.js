...
function StudentDashboard() {
  ...
  useEffect(() => {
    ...
    fetch(
      process.env.REACT_APP_API_URL + "/moyenne?studentId=" + currentUser.id
    )
      .then((response) => {
        return response.json();
      })
  ...
  useEffect(() => {
    ...
    if (
      ...
      for (var i = 0; i < students.length; i++) {
        ...
        if (
          specificData.classeId == classe.id &&
          students[i].id != currentUser.id
        ) {
    ...
    if (level !== undefined) {
      ...
      fetch(process.env.REACT_APP_API_URL + "/classes")
        ...
        .then((classes) => {
          ...
          for (let i = 0; i < classes.length; i++) {
            if (
              classes[i].niveauId == level.id &&
              classes[i].id != specificData.classeId
            ) {
  ...
  function examState(id) {
    ...
    if (number == 0) {
      return (
        <span className="badge badge-danger">You don't new have notes</span>
      );
    } else {
      return (
        <span className="badge badge-success">You have {number} new notes</span>
      );
    }
  }
                  ...
                  <div className="card-body">
                    <div className="db-widgets d-flex justify-content-between align-items-center">
                      ...
                      <div className="db-info">
                        <h3>
                          {(formation && formation.nom) || "No Formation"}
                        </h3>
                      </div>
                    </div>
                  </div>
                ...
                <div className="card bg-seven w-100">
                  <div className="card-body">
                    <div className="db-widgets d-flex justify-content-between align-items-center">
                      ...
                      <div className="db-info">
                        <h3>{(level && level.designation) || "No Level"}</h3>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="card bg-eleven w-100">
                  <div className="card-body">
                    <div className="db-widgets d-flex justify-content-between align-items-center">
                      ...
                      <div className="db-info">
                        <h3>{(classe && classe.nom) || "No Class"}</h3>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <div className="row">
          ...
          <div className="card bg-ten w-100">
            <div className="card-body">
              <div className="db-widgets d-flex justify-content-between align-items-center">
                ...
                <div className="db-info">
                  <h3>{(classmates && classmates.length) || 0}</h3>
                  <h6>Classmates</h6>
                </div>
              </div>
            </div>
          ...
          <div className="card bg-nine w-100">
            <div className="card-body">
              <div className="db-widgets d-flex justify-content-between align-items-center">
                ...
                <div className="db-info">
                  <h3>{(matieres && matieres.length) || 0}</h3>
                  <h6>Subjects</h6>
                </div>
              </div>
            </div>
        ...
        <div className="row">
          <div className="col-12 col-lg-12 col-xl-12 d-flex">
            <div className="card flex-fill">
              {matieres && (
                <DataTableExtensions {...createTableMatiere(matieres)}>
                  <DataTable
                    noHeader
        ...
        <div className="row">
          <div className="col-12 col-lg-12 col-xl-6 d-flex">
            <div className="row">
              ...
              <div className="card flex-fill">
                {classmates && (
                  <DataTableExtensions {...createTableClasseMates(classmates)}>
                    <DataTable
                      noHeader
                      defaultSortField="id"
                      defaultSortAsc={false}
          ...
          <div className="col-12 col-lg-12 col-xl-6 d-flex">
            <div className="row">
              ...
              <div className="card flex-fill">
                {lesClasses && (
                  <DataTableExtensions {...createTableClasses(lesClasses)}>
                    <DataTable
                      noHeader
                      defaultSortField="Subject"
                      defaultSortAsc={false}
        ...
        <div className="row">
          <div className="col-12 col-lg-12 col-xl-12 d-flex">
            <div className="card flex-fill">
              {notes && (
                <DataTableExtensions {...createTableNotes(notes)}>
                  <DataTable
                    noHeader
                    defaultSortField="id"
                    defaultSortAsc={false}
