...
function Register() {
  ...
  const register = async (e) => {
    ...
    if (
      ...
      confirmPasswordClass === "form-control is-invalid" ||
      lastNameClass === "form-control is-invalid" ||
      birthDateClass === "form-control is-invalid" ||
      ...
      toast.success(
        "Success. Please Check your e-mail to confirm your registration"
      );
                ...
                <form onSubmit={register}>
                  ...
                  <div className="form-group">
                    ...
                    <div class="invalid-feedback">
                      Password must have at least 8 characters, a number, a
                      symbol, an upper and lower case letter.
                    </div>
                  </div>
                  <div className="form-group">
                    <input
