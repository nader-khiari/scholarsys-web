...
function EditGrade() {
  ...
  const levelItems = levels.map((level) => {
    return (
      <option key={"level" + level.id} data-key={level.id}>
        {level.designation}
      </option>
    );
  });
  ...
  const classItems = classes.map((classes) => {
    return (
      <option key={"class" + classes.id} data-key={classes.id}>
        {classes.nom}
      </option>
    );
  });
  ...
  const items = matieres.map((matiere) => {
    return (
      <option key={matiere.id} data-key={matiere.id}>
        {matiere.designation}
      </option>
    );
  });
  ...
  const studentsItems = students.map((student) => {
    return (
      <option key={"student" + student.id} data-key={student.id}>
        {student.firstname}
      </option>
    );
  });
  ...
  const teachersItems = teachers.map((teacher) => {
    return (
      <option key={"teacher" + teacher.id} data-key={teacher.id}>
        {teacher.firstname}
      </option>
    );
  });
  ...
  const [etudiantIsValid, setEtudiantIsValid] = useState(
    "form-control is-valid"
  );
  ...
  const handleValue = (value) => {
    if (value.target.value !== undefined && value.target.value !== "") {
      if (value.target.value.match(/^(\d*\.{0,1}\d{0,3}$)/)) {
        if (
          Number.parseFloat(value.target.value) > 20 ||
          Number.parseFloat(value.target.value) < 0
        ) {
  ...
  const handleSubmit = async (grade) => {
    ...
    if (
      typeIsValid === "form-control is-invalid" ||
      valueIsValid === "form-control is-invalid" ||
      matiereIsValid === "form-control is-invalid" ||
      etudiantIsValid === "form-control is-invalid" ||
      profIsValid === "form-control is-invalid" ||
      dtPassIsValid === "form-control is-invalid"
    ) {
                ...
                <Row>
                  ...
                  <Col xs={12} sm={6}>
                    <Form.Group>
                      ...
                      <Form.Control
                        ...
                        value={oldFormation && oldFormation.nom}
                      >
                  ...
                  <Col xs={12} sm={12}>
                    <Form.Group>
                      ...
                      <Form.Control
                        className={matiereIsValid}
                        as="select"
                        onChange={handleMatiere}
                        value={matiere && matiere.designation}
                      >
                  ...
                  <Col xs={12} sm={6}>
                    <Form.Group>
                      ...
                      <Form.Control
                        className={classeIsValid}
                        as="select"
                        onChange={handleClasses}
                        value={classe && classe.nom}
                      >
                  ...
                  <Col xs={12} sm={6}>
                    <Form.Group>
                      ...
                      <Form.Control
                        className={dtPassIsValid}
                        type="date"
                        onChange={handleDtPass}
                        defaultValue={dtPass}
                      />
                    </Form.Group>
                  </Col>
